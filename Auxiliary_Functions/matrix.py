...
def generate_250_idxs(n: int) -> List[int]:
    ...
    -------
    List[int]
        A list of indices for a 16x16 grid in a zigzag pattern.
    """
...
def create_sampling_matrix(n: int, k: int, seed: int = None) -> np.ndarray:
    """
    Creates a sampling matrix based on fixed indices and randomly sampled additional indices.
